# Travel-Route-Recommendation-Bot
...
- In a terminal, navigate to `Travel-Route-Recommendation-Bot`

    ```bash
    # change into project folder
    cd Travel-Route-Recommendation-Bot/CoreBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Travel-Route-Recommendation-Bot/CoreBot` folder
...
Generated with `dotnet new corebot` v4.13.1
